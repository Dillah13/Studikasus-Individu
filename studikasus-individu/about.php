...
<body>
  ...
  <div class="col-md-12">
    ...
    <h2 class="text-start text-center font-weight-bold m-4">ABOUT US</h2>
    <div class="row">
      <div class="col-md-4">
      <h4 class="text-start font-weight-bold m-4">SIMPLICITY IN DESIGN</h4>
        <tr>
          <td><p>No flashy logos</p></td>
        </tr>
      </div>
      <div class="col-md-4">
      <h4 class="text-start font-weight-bold m-4">CONFIDENCE IN COMFORT</h4>
        <tr>
          <td><p>Trying is believing</p></td>
        </tr>
      </div>
      <div class="col-md-4 ">
      <h4 class="text-start font-weight-bold m-4">MADE FROM NATURE</h4>
        <tr>
          <td><p>The store industry often overlooks</p></td>
        </tr>
      </div>
    </div>
