...
<body>
  <nav class="navbar navbar-expand-lg bg-dark fixed-top">
    <div class="container">
      <h3><i class="fa-solid fa-cart-shopping me-2 pt-2" style="color: #ffffff"></i></h3>
      <a class="navbar-brand fw-bold text-light" href="#">SPORT SHOP</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto me-4 mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active text-light" aria-current="page" href="#">Product</a>
          </li>
          <li class="nav-item">
  ...
  <!-- <div class="row mt-5 no-gutters">
    <div class="col-md-2 bg-light">
      <ul class="list-group list-group-flush p-2 pt-1">
        <li class="list-group-item "><i class="fas fa-list"></i> Category Products</li>
        <li class="list-group-item"><i class="fas fa-angle-right"></i> T-Shirt</li>
        <li class="list-group-item"><i class="fas fa-angle-right"></i> Pants</li>
        <li class="list-group-item"><i class="fas fa-angle-right"></i> Shoes</li>
        <li class="list-group-item"><i class="fas fa-angle-right"></i> Hoodies</li>
        <li class="list-group-item"><i class="fas fa-angle-right"></i> Hats</li>
      </ul>
    </div> -->
  ...
  <div class="col-md-12">
    ...
    <h5 class="text-center font-weight-bold m-4">CHASE THE DAY</h5>

    <div class="row">
      <?php $query = $conn->query("SELECT * FROM produk"); ?>
      <?php while ($data = $query->fetch_assoc()) { ?>
        <div class="card me-2 ms-2" style="width: 16rem;">
          <img src="img/produk/nikeairforce1.jpg" class="card-img-top" alt="...">
